...
from api.db import get_gtdb_db, get_gtdb_web_db, GtdbDbDep, GtdbWebDbDep
...
@router.get(
    '/count',
    response_model=TaxonomyCountResponse,
    summary='Return the count of genomes in all species clusters.'
)
def v_get_taxonomy_count(
        db_gtdb: GtdbDbDep,
        db_web: GtdbWebDbDep,
