...
class GenomeMetadataGene(BaseModel):
    checkm_completeness: Optional[float] = Field(None)
    checkm_contamination: Optional[float] = Field(None)
    checkm_strain_heterogeneity: Optional[float] = Field(None)
    checkm2_completeness: Optional[float] = Field(None)
    checkm2_contamination: Optional[float] = Field(None)
    checkm2_model: Optional[str] = Field(None)
    lsu_5s_count: Optional[int] = Field(None)
    ssu_count: Optional[int] = Field(None)
    lsu_23s_count: Optional[int] = Field(None)
    protein_count: Optional[int] = Field(None)
    coding_density: Optional[float] = Field(None)
...
class GenomeMetadataNcbi(BaseModel):
    ...
    ncbi_molecule_count: Optional[int] = Field(None)
    ncbi_cds_count: Optional[int] = Field(None)
    ncbi_refseq_category: Optional[str] = Field(None)
    ncbi_seq_rel_date: Optional[str] = Field(None)
    ncbi_spanned_gaps: Optional[int] = Field(None)
    ncbi_species_taxid: Optional[str] = Field(None)
    ncbi_ssu_count: Optional[int] = Field(None)
    ncbi_submitter: Optional[str] = Field(None)
    ncbi_taxid: Optional[int] = Field(None)
    ncbi_total_gap_length: Optional[int] = Field(None)
    ncbi_translation_table: Optional[int] = Field(None)
    ncbi_trna_count: Optional[int] = Field(None)
    ncbi_unspanned_gaps: Optional[int] = Field(None)
