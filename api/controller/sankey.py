...
def get_search_sankey(request: SankeySearchRequest, db: Session) -> SankeySearchResponse:
    ...
    dict_releases = {'R80': 0, 'R83': 1, 'R86.2': 2, 'R89': 3, 'R95': 4, 'R202': 5, 'NCBI': 6}
    list_releases = ['R80', 'R83', 'R86.2', 'R89', 'R95', 'R202', 'NCBI']
    long_releases = ['Release 80', 'Release 83', 'Release 86.2', 'Release 89', 'Release 95', 'Release 202', 'NCBI']
    ...
    query = sql.text("""SELECT genome_id, "R80", "R83", "R86.2", "R89", "R95", "R202", "NCBI"
                              FROM CROSSTAB(
        ...
        rank_class, '';'', rank_order, '';'', rank_family, '';'', rank_genus, '';'', rank_species) AS taxonomy
                            ...
                            ORDER BY genome_id ASC, release_ver ASC;'
                               ...
                               AS ct (genome_id CHAR(10), "NCBI" VARCHAR, "R202" VARCHAR, "R80" VARCHAR, "R83" VARCHAR, "R86.2" VARCHAR,
